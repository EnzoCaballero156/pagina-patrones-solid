...
def realizar_pedido():
    ...
    nuevo_pedido = pedido_service.realizar_pedido(user_id, tema, tamaño, fecha_entrega, direccion, contacto, especificaciones, relleno, precio_total)
    ...
    return jsonify({
        ...
        "contacto": nuevo_pedido.contacto,
